        ...
        <main className="flex flex-col items-center justify-center min-h-[60vh] p-10 text-center">
            <div className="bg-red-50 p-8 rounded-3xl border border-red-100 max-w-md">
                ...
                <div className="mt-8 flex flex-col gap-3">
                    <button onClick={() => reset()} className="bg-orange-600 text-white px-6 py-3 rounded-xl font-bold 
hover:bg-orange-700 transition-colors"> // Tenta renderizar a página novamente 
